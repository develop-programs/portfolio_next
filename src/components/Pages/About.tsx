...
export default function About() {
  return (
    <div className="w-full h-screen">
      <div className="container max-w-8xl h-full flex">
        ...
        <div className="flex-1 grid space-y-6 place-content-center">
          ...
          <span className="text-sm">{data.about.desc}</span>
          <div className="space-y-3">
            {data.about.details.map((items: any, idk: any) => (
              <div className="w-full grid grid-flow-row grid-cols-5" key={idk}>
                <div className="col-span-1 font-bold text-base">
                  {items.title} :
                </div>
                <div className="col-span-4 text-base cursor-default">
